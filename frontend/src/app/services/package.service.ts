...
export class PackageService {
  ...
  public get() {
    this.http.get(`${environment.api}/packages`).subscribe( res => {
  ...
  public save(pkg: any){
    ...
    if (pkg._id == 'new'){
      return this.http.post(`${environment.api}/packages`,saveable);
    } else {
      return this.http.put(`${environment.api}/packages/${pkg._id}`,saveable);
    }
  }

  public delete(_id: string){
    this.http.delete(`${environment.api}/packages/${_id}`).subscribe( () => this.get() );
  }
