...
export class CallService {
  ...
  public save(call: any){
    if (call._id == 'new'){
      return this.http.post(`${environment.api}/mycalls`,call.toSaveObject());
    } else {
      return this.http.put(`${environment.api}/mycalls/${call._id}`,call.toSaveObject());
    }
  }

  public delete(_id: string){
    this.http.delete(`${environment.api}/mycalls/${_id}`).subscribe( () => this.get() );
  }
